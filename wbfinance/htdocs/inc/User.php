...
class User {
  ...
  function changePass($id_user, $old_pass, $new_pass) {
    ...
    if ($ok) {
      ...
      logmessage("Mot de passe pour user:$id_user chang̩");
      $_SESSION['message'] = "Mot de passe modifi̩";
    } else {
  ...
  function setPrefs($prefs) {
    ...
    $_SESSION['message'] = "Vos pr̩f̩rences sont enregistr̩es";
  }
