...
if (file_exists($_FILES['logo']['tmp_name'])) {
  mysql_query("DELETE FROM pref WHERE type_pref='logo'");
  ...
  mysql_query("INSERT INTO pref (owner,value,type_pref) values(-1, '$data', 'logo')");
}

// Enregistrement adresse et raison sociale
mysql_query("DELETE FROM pref WHERE type_pref='societe'");
...
mysql_query("INSERT INTO pref (type_pref, value) VALUES('societe', '$data');") or die(mysql_error());

// Enregistrement compte(s) banquaire(s)
mysql_query("DELETE FROM pref WHERE type_pref='rib'");
