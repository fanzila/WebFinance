...
--
-- Table structure for table `webfinance_accounts`
--
...
--
-- Dumping data for table `webfinance_accounts`
--

INSERT INTO `webfinance_accounts` (`id`, `account_name`, `id_bank`, `id_user`, `account`, `comment`, `currency`, `country`, `type`) VALUES (12, 'My first account', 26, 0, '666-007-000', 'no comment', 'EUR', 'AM', 'Credit card'),
(14, 'Soci&eacute;t&eacute;', 26, 0, '666-007-000', '', 'EUR', 'FR', 'Credit card');

-- --------------------------------------------------------

--
-- Table structure for table `webfinance_banks`
--
...
--
-- Dumping data for table `webfinance_banks`
--

INSERT INTO `webfinance_banks` (`id`, `name`, `short_name`, `phone`, `mail`, `comment`) VALUES (26, 'Banque populaire', 'banque_populaire', '111121212121', 'worldbank@worldbank.com', 'no comment'),
...
--
-- Dumping data for table `webfinance_categories`
--

INSERT INTO `webfinance_categories` (`id`, `name`, `comment`, `color`) VALUES (2, 'TestCAteg', 'commentaire', 'SkyBlue'),
...
--
-- Dumping data for table `webfinance_clients`
--

INSERT INTO `webfinance_clients` (`id_client`, `nom`, `date_created`, `tel`, `fax`, `addr1`, `cp`, `ville`, `addr2`, `addr3`, `pays`, `vat_number`, `has_unpaid`, `state`, `ca_total_ht`, `ca_total_ht_year`, `has_devis`, `email`, `siren`, `total_du_ht`, `id_type_entreprise`) VALUES (1, 'Entreprise X', '2006-04-06 10:57:27', '313131', '', 'Antananarivo', '', '', '', '', 'France', '', 1, 'prospect', 42.0000, 42.0000, 0, '', '', 42.0000, 1);
...
--
-- Dumping data for table `webfinance_company_types`
--

INSERT INTO `webfinance_company_types` (`id_type_entreprise`, `nom`) VALUES (1, 'Client'),
(2, 'Prospect'),
(3, 'Fournisseur'),
(4, 'Archive');
...
--
-- Dumping data for table `webfinance_dns`
--
...
--
-- Dumping data for table `webfinance_domain`
--
...
--
-- Table structure for table `webfinance_expense_details`
--
...
--
-- Dumping data for table `webfinance_expense_details`
--
...
--
-- Dumping data for table `webfinance_expenses`
--
...
--
-- Dumping data for table `webfinance_invoice_rows`
--

INSERT INTO `webfinance_invoice_rows` (`id_facture_ligne`, `id_facture`, `description`, `qtt`, `ordre`, `prix_ht`) VALUES (5, 7, 0x74657374, 2.00, NULL, 21.00000);
...
--
-- Dumping data for table `webfinance_invoices`
--

INSERT INTO `webfinance_invoices` (`id_facture`, `id_client`, `date_created`, `date_generated`, `date_sent`, `date_paiement`, `is_paye`, `num_facture`, `type_paiement`, `ref_contrat`, `extra_top`, `facture_file`, `accompte`, `extra_bottom`, `date_facture`, `type_doc`, `commentaire`, `id_type_presta`, `id_compte`, `is_envoye`) VALUES (2, 1, '2006-04-06 12:06:06', NULL, NULL, NULL, 0, NULL, 'Ã€ rÃ©ception de cette facture', NULL, NULL, NULL, 0.0000, NULL, '2006-04-06 12:06:06', 'facture', NULL, 1, 34, 0),
...
--
-- Dumping data for table `webfinance_naf`
--
...
--
-- Dumping data for table `webfinance_pref`
--
...
--
-- Dumping data for table `webfinance_publication_method`
--
...
--
-- Dumping data for table `webfinance_suivi`
--
...
--
-- Dumping data for table `webfinance_type_presta`
--
...
--
-- Dumping data for table `webfinance_type_suivi`
--
...
--
-- Dumping data for table `webfinance_type_tva`
--
...
--
-- Dumping data for table `webfinance_userlog`
--
...
--
-- Dumping data for table `webfinance_users`
--
...
--
-- Constraints for table `webfinance_accounts`
--
...
--
-- Constraints for table `webfinance_dns`
--
...
--
-- Constraints for table `webfinance_expense_details`
--
...
--
-- Constraints for table `webfinance_transactions`
--
