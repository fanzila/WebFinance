...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'order.update_type'
        db.add_column('invoice_order', 'update_type', self.gf('django.db.models.fields.CharField')(default='setup', max_length=18, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'order.update_type'
        db.delete_column('invoice_order', 'update_type')
