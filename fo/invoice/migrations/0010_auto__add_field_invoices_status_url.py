...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoices.status_url'
        db.add_column(u'webfinance_invoices', 'status_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoices.status_url'
        db.delete_column(u'webfinance_invoices', 'status_url')
