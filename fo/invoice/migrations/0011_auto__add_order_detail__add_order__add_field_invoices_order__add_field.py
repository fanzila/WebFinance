...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'order_detail'
        db.create_table('invoice_order_detail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.order'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=5, blank=True)),
            ('first', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('invoice', ['order_detail'])

        # Adding model 'order'
        db.create_table('invoice_order', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application_uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.order'], null=True, blank=True)),
            ...
            ('order_type', self.gf('django.db.models.fields.CharField')(default='subscription', max_length=32)),
            ('service_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('status_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('invoice', ['order'])

        # Adding field 'Invoices.order'
        db.add_column(u'webfinance_invoices', 'order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.order'], null=True, blank=True), keep_default=False)

        # Adding field 'Subscription.order'
        db.add_column(u'webfinance_subscription', 'order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.order'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'order_detail'
        db.delete_table('invoice_order_detail')

        # Deleting model 'order'
        db.delete_table('invoice_order')

        # Deleting field 'Invoices.order'
        db.delete_column(u'webfinance_invoices', 'order_id')

        # Deleting field 'Subscription.order'
        db.delete_column(u'webfinance_subscription', 'order_id')
    ...
    models = {
        ...
        'invoice.invoices': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoice.order']", 'null': 'True', 'blank': 'True'}),
        ...
        'invoice.order': {
            ...
            'application_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['enterprise.Clients']"}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order_type': ('django.db.models.fields.CharField', [], {'default': "'subscription'", 'max_length': '32'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoice.order']", 'null': 'True', 'blank': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'default': "'monthly'", 'max_length': '16'}),
            'service_name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'status_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'invoice.order_detail': {
            'Meta': {'object_name': 'order_detail'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'first': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoice.order']"}),
            'price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '5', 'blank': 'True'}),
