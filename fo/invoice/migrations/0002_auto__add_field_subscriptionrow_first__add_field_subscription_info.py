...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubscriptionRow.first'
        db.add_column(u'webfinance_subscription_rows', 'first', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Subscription.info'
        db.add_column(u'webfinance_subscription', 'info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubscriptionRow.first'
        db.delete_column(u'webfinance_subscription_rows', 'first')

        # Deleting field 'Subscription.info'
        db.delete_column(u'webfinance_subscription', 'info')
