...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.service_name'
        db.add_column(u'webfinance_subscription', 'service_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.service_name'
        db.delete_column(u'webfinance_subscription', 'service_name')
