...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.status_url'
        db.add_column(u'webfinance_subscription', 'status_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.status_url'
        db.delete_column(u'webfinance_subscription', 'status_url')
