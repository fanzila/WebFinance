...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoices.subscription'
        db.add_column(u'webfinance_invoices', 'subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.Subscription'], null=True, blank=True), keep_default=False)

        # Adding field 'Subscription.status'
        db.add_column(u'webfinance_subscription', 'status', self.gf('django.db.models.fields.CharField')(default='running', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoices.subscription'
        db.delete_column(u'webfinance_invoices', 'subscription_id')

        # Deleting field 'Subscription.status'
        db.delete_column(u'webfinance_subscription', 'status')
