...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.payment_date'
        db.add_column(u'webfinance_subscription', 'payment_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Subscription.reminder_sent_date'
        db.add_column(u'webfinance_subscription', 'reminder_sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.payment_date'
        db.delete_column(u'webfinance_subscription', 'payment_date')

        # Deleting field 'Subscription.reminder_sent_date'
        db.delete_column(u'webfinance_subscription', 'reminder_sent_date')
    ...
    models = {
        ...
        'invoice.invoices': {
            ...
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoice.Subscription']", 'null': 'True', 'blank': 'True'}),
