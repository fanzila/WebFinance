...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'order.checkout_url'
        db.add_column('invoice_order', 'checkout_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'order.uuid'
        db.add_column('invoice_order', 'uuid', self.gf('django.db.models.fields.CharField')(default=0, max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'order.checkout_url'
        db.delete_column('invoice_order', 'checkout_url')

        # Deleting field 'order.uuid'
        db.delete_column('invoice_order', 'uuid')
    ...
    models = {
        ...
        'invoice.order': {
            ...
            'checkout_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
