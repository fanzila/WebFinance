...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'webfinance_subscription', 'paid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.paid'
        db.delete_column(u'webfinance_subscription', 'paid')
