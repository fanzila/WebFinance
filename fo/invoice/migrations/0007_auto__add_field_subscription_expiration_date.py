...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.expiration_date'
        db.add_column(u'webfinance_subscription', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.expiration_date'
        db.delete_column(u'webfinance_subscription', 'expiration_date')
